var GasTap = (function() {
  ...
  var GasTap = function(options) {
    ...
    if (typeof loggerFunc != 'function')
      throw Error(
        'options.logger must be a function to accept output parameter'
      );
    ...
    test.totalFailed = function() {
      return totalFail;
    };
    test.totalSucceed = function() {
      return totalSucc;
    };
    test.totalSkipped = function() {
      return totalSkip;
    };
    ...
    function deepEqual(v1, v2, msg) {
      ...
      function recursionDeepEqual(rv1, rv2) {
        ...
        for (var k in rv1) {
          if (!(k in rv2) || typeof rv1[k] != typeof rv2[k]) return false;
    ...
    function notDeepEqual(v1, v2, msg) {
      ...
      function recursionNotDeepEqual(rv1, rv2) {
        ...
        for (var k in rv1) {
          if (!(k in rv2) || typeof rv1[k] != typeof rv2[k]) return true;
